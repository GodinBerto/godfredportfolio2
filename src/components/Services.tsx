      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              <div className="w-16 h-16 bg-blue-900 text-yellow-300 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-yellow-400 group-hover:text-blue-900 transition-colors">
                <service.icon size={28} />
              </div>
              <h3 className="text-xl font-semibold mb-3 group-hover:text-white">
                {service.title}
              </h3>
              <p className="text-muted-foreground group-hover:text-white/70 text-sm mb-6">
                {service.description}
              </p>
              <Link
                href="#contact"
                className="inline-flex items-center gap-2 text-sm font-medium text-blue-900 group-hover:text-white hover:gap-3 transition-all"
              >
